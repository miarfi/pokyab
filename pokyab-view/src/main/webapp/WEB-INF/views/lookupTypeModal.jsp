            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <sf:form 
                        ...
                        <div class="form-group">
                            <label for="systemFlag" class="control-label col-md-4"><spring:message code="lookupType.table.systemFlag"/>:</label>
                            <div class="col-md-8">
                                <sf:input path="systemFlag" id="systemFlag" type="text" class="form-control"/>
                            </div>
                        </div>                                                             
                        <div class="form-group">								
