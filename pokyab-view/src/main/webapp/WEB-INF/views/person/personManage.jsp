...
<!--    <div class="row">
        <div class="col-12 col-xl-8">
            <div class="text-right">
                <br/>               
                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#myLocationModal">
                    <spring:message code="person.table.btn.addLocation"/>
                </button>
                <br/>  
            </div>      
        </div>
    ...
    <%@include  file="locationModal.jsp"%> 
