                   ...
                   <div class="panel-body">
                       <form action="${contextRoot}/login" method="POST" class="form-horizontal"
                           ...
                           <div class="form-group row">
                               <label for="username" class="col-md-4 control-label"><spring:message code="login.field.username"/>: </label>
                               <div class="col-md-8">
                                   <input type="text" name="username" id="username" class="form-control"/>
                               </div>
                           </div>
                           <div class="form-group row">
                               <label for="password" class="col-md-4 control-label"><spring:message code="login.field.password"/>: </label>
                               <div class="col-md-8">
